...
namespace TextClustering.Lib
{
    ...
    public static class DocumnetClustering
    {
        ...
        public static List<Centroid> mainCentroids;
        ...
        public static List<Centroid> PrepareDocumentCluster(int k, List<DocumentVector> documentCollection, ref int _counter, string sim, List<ClusterNode> allClusters, string dataSet, int maxNoDoc)
        {
            ...
            //
            Console.WriteLine(String.Join(",", uniqRand));
            ...
            do
            {
                ...
                {
                    int index = FindClosestClusterCenter(centroidCollection, obj, sim);
