...
namespace TextClustering.Lib
{
    ...
    class VectorSpaceModel
    {
        ...
        public static List<DocumentVector> ProcessDocumentCollection(DocumentCollection collection)
        {
             ...
             * 
             */
            int t = 1, indexDistinctTerms = 1, indexVectorSpace = 1;
            foreach (string documentContent in collection.DocumentList)
            {
                Console.WriteLine("Start documentContent for StopWordsHandler at " + t);
            ...
            {
               Console.WriteLine("Start documentContent for distinctTerms at " + indexDistinctTerms);
            ...
            {
                Console.WriteLine("Start documentContent for VectorSpace at " + indexVectorSpace);
                int count = 0;
